...
species_condensed = species[["category", "common_names", "conservation_status"]]
print(species_condensed.head(20))
...
py = species.fillna('No Intervention', inplace = True)
...
chi2, pval, c, d = chi2_contingency(contingency)
print(pval)
...
e, pval_reptile_mammal, f, g = chi2_contingency(reptile_mammal)
...
print(sheep_observations.head(20))
